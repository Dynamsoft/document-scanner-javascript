...
import DocumentNormalizerView, { DocumentNormalizerViewConfig } from "../class/DocumentNormalizerView";
import DocumentScannerView, { DocumentScanResult } from "../class/DocumentScannerView";
import ScanResultView, { ScanResultViewConfig } from "../class/ScanResultView";

// Default DCE UI path
const DEFAULT_DCE_UI_PATH = "./dist/mwc-2.ui.html";
