...
class DocumentScanner {
    ...
    async initialize(): Promise<{
        ...
        try {
            ...
            // Pass the parent variable along
            this.resources._parentScanner = this;
    ...
    dispose(): void {
        ...
        // Add the following lines to also remove the container from the page.
        if (typeof this.config.container === "string") {
            document.querySelector(this.config.container).remove();
        }
        else
